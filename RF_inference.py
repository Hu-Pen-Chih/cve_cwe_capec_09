...
# 加載模型和向量化器
vectorizer = joblib.load('train_model/random_forest/train_model_save/vectorizer_cvecwe.joblib')
boruta_selector = joblib.load('train_model/random_forest/train_model_save/boruta_selector_cvecwe.joblib')
clf = joblib.load('train_model/random_forest/train_model_save/random_forest_model_cvecwe.joblib')

vectorizer_capec = joblib.load('train_model/random_forest/train_model_save/vectorizer_cvecapec.joblib')
boruta_selector_capec = joblib.load('train_model/random_forest/train_model_save/boruta_selector_cvecapec.joblib')
clf_capec = joblib.load('train_model/random_forest/train_model_save/random_forest_model_cvecapec.joblib')
print("模型和向量化器加載成功。")
