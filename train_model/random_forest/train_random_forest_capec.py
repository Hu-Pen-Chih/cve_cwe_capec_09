...
balanced_samples_path_cve_capec = 'train_data/2023_CVE_CAPEC.csv'
...
# 將數據集拆分為訓練集和驗證集
train_texts = val_texts = balanced_samples[['CVE-Description', 'CAPEC-Description']]
...
X_train = vectorizer.fit_transform(train_texts['CAPEC-Description'] + ' ' + train_texts['CVE-Description'])
print("特徵數量:", X_train.shape[1])
X_val = vectorizer.transform(val_texts['CAPEC-Description'] + ' ' + val_texts['CVE-Description'])
